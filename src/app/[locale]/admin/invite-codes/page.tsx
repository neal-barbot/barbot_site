    ...
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">{t("invite_codes.description")}</p>
        </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t("invite_codes.create_description")}</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={submitCreate} disabled={submitting}>
              {submitting ? t("invite_codes.creating") : t("invite_codes.create_submit")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!deletingId} onOpenChange={(v) => !v && setDeletingId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t("invite_codes.delete_description")}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
