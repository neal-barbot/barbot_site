      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl">{t("sign.reset_password_title")}</CardTitle>
            {!success && tokenChecked && token && (
              <CardDescription>{t("sign.reset_password_description")}</CardDescription>
            )}
          </CardHeader>
          <CardContent>
            {!tokenChecked ? null : !token ? (
              ...
              <FieldGroup>
                <p className="text-sm text-center">{t("sign.reset_password_success")}</p>
                <Field>
                  <Link
                    href="/sign-in"
                    className="text-sm text-center underline underline-offset-4"
              ...
              <form onSubmit={handleSubmit}>
                <FieldGroup>
                  ...
                  <Field>
                    <FieldLabel htmlFor="password">{t("sign.new_password_title")}</FieldLabel>
                    <Input
                      id="password"
                      type="password"
                      value={password}
