...
export function getSettings(): Setting[] {
  return [
    ...
    { name: 'agent_relay_model', title: 'Agent relay default model (free)', type: 'text', placeholder: 'deepseek-v4-flash', group: 'openai', tab: 'ai' },
    { name: 'agent_relay_models', title: 'Agent relay selectable models', type: 'text', placeholder: 'deepseek-v4-flash,deepseek-v4-pro', group: 'openai', tab: 'ai' },
