...
function buildImagePrompt(description: string, language: string): string {
  ...
  return [
    'Create a clean EE functional block diagram (electronics system architecture diagram) for:',
    description.slice(0, 1500),
    '',
    'Layout conventions: signal flow left to right — power input and connectors on the left,',
    'main controller in the center, outputs/communication on the right.',
    'Functional groups (power, control, analog front-end, communication, protection, load)',
    'visually clustered with subtle background tints.',
    'Each block is a rounded rectangle with the component part number or function name,',
    'connected by clear orthogonal arrows labeled with the interface or rail (e.g. "5V", "3.3V", "SPI", "CAN", "isoSPI").',
    'Dashed arrows for feedback/enable/alert lines.',
    '',
    `All label text in ${lang}. Crisp, legible engineering typography.`,
    'Style: clean technical documentation diagram on a white background, flat design,',
    'thin lines, restrained color palette, like a professional datasheet application diagram.',
